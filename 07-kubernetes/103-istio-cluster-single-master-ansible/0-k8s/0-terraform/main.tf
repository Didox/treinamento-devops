...
output "master" {
  value = [
    ...
    "ssh -i ~/Desktop/devops/Treinamento ubuntu@${aws_instance.master.public_dns}"
  ]
}
...
output "aws_instance_e_ssh" {
  value = [
    ...
    "worker ${key + 1} - private - ${item.private_ip} - public - ${item.public_ip} - ssh -i ~/Desktop/devops/Treinamento ubuntu@${item.public_dns}"
  ]
}